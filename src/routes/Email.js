    ...
    return(
       <div className='Container'>
        ...
        <div className='boxPerfil' style={{width: '85vw', margin: 'auto', height:'50vh'}}>
            <div className='form'>
            <div className='boxAbout' style={{flexDirection:'row', width: '70vw'}}><input placeholder='Email atual'className='inputForm' type='email'></input><img style={{width: '3vh'}} src={Mail} alt='mail'></img></div>
            <div className='boxAbout' style={{flexDirection:'row', width: '70vw'}}><input placeholder='Escreva aqui seu novo email' className='inputForm' type='email'></input><img style={{width: '3vh'}} src={Mail} alt='mail'></img></div>
