    ...
    return(
       <div className='Container'>
        ...
        <div className='boxPerfil' style={{width: '85vw', margin: 'auto', height:'50vh'}}>
            <div className='form'>
            <div className='boxAbout' style={{flexDirection:'row', width: '70vw'}}><input placeholder='Digite seu telefone atual'className='inputForm' type='date'></input><img style={{width: '3vh'}} src={date} alt='date'></img></div>
            <div className='boxAbout' style={{flexDirection:'row', width: '70vw'}}><input placeholder='Escreva aqui seu novo telefone' className='inputForm' type='date'></input><img style={{width: '3vh'}} src={date} alt='date'></img></div>
